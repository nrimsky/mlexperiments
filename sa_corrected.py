...
class SimulatedAnnealing(Optimizer):
	'''Here I'm replacing the group-by group randomness by uniform randomness. May be 
		interesting to try to put groups back in later -dmitry'''
...
#		generating params instead of groups
		...
		vectorized_params = parameters_to_vector(params)
